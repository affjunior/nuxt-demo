export default {
        ...
        lessons: [
          {
            ...
            number: 1,
            downloadUrl:
              'https://test/lessons/introduction-to-typescript-with-vue-js-3',
            videoId: 684236333,
  ...
  We also answer the question: “Are there any cases when you wouldn’t want to use TypeScript?”.`,
          },
          {
            ...
            number: 2,
            downloadUrl:
              'https://test/lessons/typescript-in-vue-components',
            videoId: 684012498,
          ...
          },
          {
            ...
            number: 3,
            downloadUrl:
              'https://test/lessons/typing-component-events',
            sourceUrl:
              'https://test/lessons/typing-component-events',
            videoId: 686921522,
        ...
        lessons: [
          {
            ...
            number: 1,
            downloadUrl:
              'https://test/lessons/using-typescript-with-the-options-api-in-components',
            sourceUrl:
              'https://test/lessons/using-typescript-with-the-options-api-in-components',
            videoId: 688503389,
          ...
          },
          {
            ...
            number: 2,
            downloadUrl:
              'https://test/lessons/declaring-and-typing-component-props',
            sourceUrl:
              'https://test/lessons/declaring-and-typing-component-props',
            videoId: 688500728,
